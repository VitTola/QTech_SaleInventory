...
namespace Storm.UI
{
    public partial class MainForm : ExDialog
    {
        ...
        {
            var ListTopMenue = new List<ExTabItem>
            {
            new ExTabItem()
            {
                ...
                Padding = new Padding() { All = 0 }
                    ...
                    new ExTabItem()
            {
                Name = nameof(frmEmployee),
                Tag = new frmEmployee(),
                Text = QTech.Base.Properties.Resources.Employees,
                Image = QTech.Base.Properties.Resources.Employee_img,
                TextAlignment = ContentAlignment.MiddleLeft,
                BorderStyle = BorderStyle.None,
                Padding = new Padding() { All = 0 }
            },
              new ExTabItem()
            {
                Name = nameof(frmProduct),
                Tag = new frmProduct(),
                Text = QTech.Base.Properties.Resources.Products,
                Image = QTech.Base.Properties.Resources.Product_img,
                TextAlignment = ContentAlignment.MiddleLeft,
                BorderStyle = BorderStyle.None,
                Padding = new Padding() { All = 0 }
            },
            ...
            ListTopMenue.ForEach(x =>
            {
                pTopMenu.AddTabItem(x);
                x.Click += Tab_Click;
            }
            );
        }
