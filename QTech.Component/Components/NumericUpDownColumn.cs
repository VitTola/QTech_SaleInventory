...
namespace QTech.Component.Components
{
    class NumericUpDownEditingControl : NumericUpDown, IDataGridViewEditingControl
    {
        ...
        public virtual void ApplyCellStyleToEditingControl(DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            this.TextAlign = NumericUpDownCell.TranslateAlignment(dataGridViewCellStyle.Alignment);
        }
    ...
    public class NumericUpDownCell : DataGridViewTextBoxCell
    {
        ...
        private static Type defaultEditType = typeof(NumericUpDownEditingControl);
        ...
        /// </summary>
        private NumericUpDownEditingControl EditingNumericUpDown
        {
            get
            {
                return this.DataGridView.EditingControl as NumericUpDownEditingControl;
            }
        }
        ...
        {
            NumericUpDownCell dataGridViewCell = base.Clone() as NumericUpDownCell;
        ...
        private bool OwnsEditingNumericUpDown(int rowIndex)
        {
            ...
            NumericUpDownEditingControl numericUpDownEditingControl = this.DataGridView.EditingControl as NumericUpDownEditingControl;
                                      ...
                                      DataGridViewAdvancedBorderStyle advancedBorderStyle, DataGridViewPaintParts paintParts)
        {
            ...
            if (!cellEdited)
            {
                if (PartPainted(paintParts, DataGridViewPaintParts.ContentForeground))
                {
                    ...
                    paintingNumericUpDown.TextAlign = NumericUpDownCell.TranslateAlignment(cellStyle.Alignment);
    ...
    public class NumericUpDownColumn : DataGridViewColumn
    {
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                NumericUpDownCell dataGridViewNumericUpDownCell = value as NumericUpDownCell;
        ...
        [
            Category("Appearance"),
            DefaultValue(NumericUpDownCell.DATAGRIDVIEWNUMERICUPDOWNCELL_defaultDecimalPlaces),
            ...
            set
            {
                ...
                if (this.DataGridView != null)
                {
                    ...
                    for (int rowIndex = 0; rowIndex < rowCount; rowIndex++)
                    {
                        ...
                        NumericUpDownCell dataGridViewCell = dataGridViewRow.Cells[this.Index] as NumericUpDownCell;
                        if (dataGridViewCell != null)
                        {
        ...
        {
            return !this.Increment.Equals(NumericUpDownCell.DATAGRIDVIEWNUMERICUPDOWNCELL_defaultIncrement);
        }
        ...
        {
            return !this.Maximum.Equals(NumericUpDownCell.DATAGRIDVIEWNUMERICUPDOWNCELL_defaultMaximum);
        }
        ...
        {
            return !this.Minimum.Equals(NumericUpDownCell.DATAGRIDVIEWNUMERICUPDOWNCELL_defaultMinimum);
        }
        ...
        [
            Category("Data"),
            DefaultValue(NumericUpDownCell.DATAGRIDVIEWNUMERICUPDOWNCELL_defaultThousandsSeparator),
        ...
        /// </summary>
        private NumericUpDownCell NumericUpDownCellTemplate
        {
            get
            {
                return (NumericUpDownCell)this.CellTemplate;
            }
        }
