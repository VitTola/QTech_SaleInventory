...
//            var ws = wb.Worksheets.Add(EDomain.Resources.AuditTrail);
...
//                rowDate.Value = $"{EDomain.Resources.Dated}៖ {DateTime.Now.ToString("F")}";
...
//        { 
//            this.Text = string.Format(EDomain.Resources.UpdateHistory__, ResourceHelper.Translate(Model.GetType().Name), ((string.IsNullOrEmpty(ItemName)) ? Model.ToString() : ItemName));
...
//                var json = AuditTrailAPI.Instance.Serializer.DeserializeObject<List<ChangeLog>>(audit.ChangeJson);
//                if (json==null)
//                {
//                    continue;
//                }
