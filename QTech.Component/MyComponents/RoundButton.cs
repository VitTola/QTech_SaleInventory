...
namespace QTech.Component.MyComponents
{
    public partial class RoundButton : Button
    {
        ...
        public int BorderOverWidth { get; set; }
        public Color BorderOverColor { get; set; }


        public int BorderDownWidth { get; set; }
        ...
        //    GraphicsPath GraphPath = GetRoundPath(Rect, radius, BorderRadius);
